...
facelabel = ["yangmi", "liuyifei", "wulei", "yyqx","luorun"]  # 人物名
...
# test_img = cv2.imread("./photo/liuyifei/lyf4.jpg")
#test_img = cv2.imread("./photo/wl/2.jpg")
# test_img = cv2.imread("./photo/luorun/78.jpg")#太小的话不能识别出人脸
test_img = cv2.imread("./photo/luorun/37.jpg")
#test_img = cv2.imread("./e.jpg")
